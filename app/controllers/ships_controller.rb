class ShipsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @ship.save
        format.html { redirect_to @ship, notice: 'Schip is succesvol aangemaakt.' }
  ...
  def update
    respond_to do |format|
      if @ship.update(ship_params)
        format.html { redirect_to @ship, notice: 'Schip is succesvol gewijzigd.' }
  ...
  def destroy
    @ship.destroy
    respond_to do |format|
      format.html { redirect_to ships_url, notice: 'Schip is succesvol verwijderd.' }
  ...
  private
    ...
    def ship_params
      params.require(:ship).permit(:classtype, :name, :damage, :course_kind_id)
    end
end
